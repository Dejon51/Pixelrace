...
down_end, _, _ = bmptoarray("dend.bmp")
up_end, _, _ = bmptoarray("uend.bmp")
left_end, _, _ = bmptoarray("lend.bmp")
right_end, _, _ = bmptoarray("rend.bmp")
...
for i in range(len(path)):
    ...
    if in_dir in [(0, 1), (0, -1)] and out_dir in [(0, 1), (0, -1)]:
        tile_name = "vertical"
    elif in_dir in [(1, 0), (-1, 0)] and out_dir in [(1, 0), (-1, 0)]:
